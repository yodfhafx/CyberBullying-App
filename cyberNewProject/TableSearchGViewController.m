...
#import "TableSearchGViewController.h"
#import "searchGViewController.h"

@interface TableSearchGViewController () <UISearchDisplayDelegate>

@end

@implementation TableSearchGViewController
...
-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    {
        searchGViewController *v = segue.destinationViewController;
