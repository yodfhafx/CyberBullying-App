...
#import "Table2GViewController.h"
#import "Detail2GViewController.h"

@interface Table2GViewController ()

@end

@implementation Table2GViewController
@synthesize arrData;
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender  {
    Detail2GViewController *v = [[Detail2GViewController alloc]init];
